...
function AnimatedContent({slice}: {slice: Content.HeroSlice}) {
    ...
    <div>
      <div className="relative" ref={container}>
              ...
              {isFilled.link(slice.primary.button_link) && (
                 <ButtonLink className="mt-8 hero__button opacity-0" field={slice.primary.button_link} >{slice.primary.button_label}</ButtonLink>
              )}
              {isFilled.image(slice.primary.image) && (
                 <div className="hero__image glass-container mt-16 w-fit opacity-0">
                  <div className="hero__glow absolute inset-0 -z-10 bg-blue-400/30 blur-2xl filter opacity-0" />
                  <PrismicNextImage 
